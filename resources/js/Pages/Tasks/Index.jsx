...
export default function Index() {
  ...
  return (
    <div className="relative max-w-6xl mx-auto mt-10 p-6 min-h-screen rounded-3xl shadow-2xl border border-indigo-200 overflow-hidden
                    bg-gradient-to-br from-pink-50 via-blue-50 to-indigo-100">
